...
public:
	...
	acl_ipv4_t(string_t const &, config_t const &config);
	~acl_ipv4_t() throw();
};
...
acl_ipv4_t::acl_ipv4_t(string_t const &, config_t const &config) :
...
acl_ipv4_t::~acl_ipv4_t() throw() { delete [] items; }
